...
public class YoyoNavigationMethod extends TouchNavigationMethod {
    ...
    private class Yoyo {
        ...
        public Yoyo() {
            ...
            HANDLE_BLOAT = new Rect(radius, 0, 0, (int) HANDLE_RECT.bottom + YOYO_STRING_RESTING_HEIGHT);
        ...
        public void draw(Canvas canvas, boolean activated) {
            ...
            canvas.drawArc(new RectF(_anchorX - (int) (radius * 2), _anchorY - radius - YOYO_STRING_RESTING_HEIGHT, _handleX + (int) (radius * 3), _handleY + radius), 60, 60, true, _brush);
        ...
        public void invalidateHandle() {
            Rect handleExtent = new Rect(_handleX, _handleY, _handleX + HANDLE_RECT.right, _handleY + HANDLE_RECT.bottom);
        ...
        public Pair findNearestChar(int handleX, int handleY) {
            ...
            return new Pair(_textField.coordToCharIndex(attachedLeft, attachedBottom), _textField.coordToCharIndexStrict(attachedLeft, attachedBottom));
        }
        ...
        public boolean isInHandle(int x, int y) {
            return _isShow && (x >= _handleX && x < (_handleX + HANDLE_RECT.right) && y >= _handleY && y < (_handleY + HANDLE_RECT.bottom));
        }
    }//end inner class
}
