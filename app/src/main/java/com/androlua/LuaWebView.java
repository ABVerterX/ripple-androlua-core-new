...
public class LuaWebView extends WebView implements LuaGcable {
        ...
        setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                if (mAdsFilter != null) {
                    try {
                        Boolean ret = mAdsFilter.call(url);
                        if (ret != null && ret) return new WebResourceResponse(null, null, null);
                    } catch (LuaException e) {
                        e.printStackTrace();
                    }
                }
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                ...
                b.setPositiveButton(android.R.string.ok, (dialog, which) -> handler.proceed());
                b.setNegativeButton(android.R.string.cancel, (dialog, which) -> handler.cancel());
    ...
    public void openFile(String dir) {
        ...
        if (fs != null) {
            Arrays.sort(fs);
            for (String k : fs) {
                if (new File(mDir + k).isDirectory()) ns.add(k + "/");
            }

            for (String k : fs) {
                if (new File(mDir + k).isFile()) ns.add(k);
            }
    ...
    public interface LuaWebViewClient {
        ...
        public void onReceivedClientCertRequest(WebView view, ClientCertRequest handler, String host_and_port);
    ...
    private class Download implements DownloadListener {
        ...
        public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
            ...
            new AlertDialog.Builder(mContext).setTitle(DOWNLOAD).setMessage("Type: " + mimetype + "\nSize: " + size).setView(file_input_field).setPositiveButton(DOWNLOAD, new DialogInterface.OnClickListener() {
                @Override
            ...
            }).setNegativeButton(android.R.string.cancel, null).setNeutralButton("Only Wifi", new DialogInterface.OnClickListener() {
    ...
    private class SimpleLuaWebViewClient extends WebViewClient {
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
            if (mAdsFilter != null) {
                try {
                    if (mAdsFilter.call(url)) return new WebResourceResponse(null, null, null);
                } catch (LuaException e) {
                    e.printStackTrace();
                }
            }
    ...
    class LuaWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message, final android.webkit.JsResult result) {
            new AlertDialog.Builder(mContext).setTitle(url).setMessage(message).setPositiveButton(android.R.string.ok, new AlertDialog.OnClickListener() {
        ...
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, final JsPromptResult result) {
            ...
            b.setPositiveButton(android.R.string.ok, new AlertDialog.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    String value = prompt_input_field.getText().toString();
