package com.androlua.accessibility;
...
import com.androlua.accessibility.screencapture.ScreenCaptureListener;
import com.androlua.accessibility.screencapture.ScreenShot;
...
public class LuaAccessibilityService extends AccessibilityService {
    ...
    public void getScreenshot(final LuaFunction listener) {
        ScreenShot.getScreenCaptureBitmap(this, new ScreenCaptureListener() {
            @Override            public void onScreenCaptureDone(Bitmap bitmap) {
                try {
